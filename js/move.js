		...
		$.getJSON(jsonLocation, function(data){
			...
			function startbar(){
				...
				if($('#slide-wrap').find('.controll').length<1){
					$('#slide-wrap').append('<span class="timebar" style="display:inline-block;position:absolute;top:0px;right:120px;width:0;height:30px;background:rgba(0,0,0,0.7);z-index:1"></span>')
