		...
		$.getJSON(jsonLocation, function(data){
			...
			function startbar(){
				...
				if($('#slide-wrap').find('.controll').length<1){
					$('#slide-wrap').append('<span class="timebar" style="display:inline-block;position:absolute;top:0px;left:0px;width:0;height:100%;background:rgba(255,255,255,1);z-index:-1"></span>')
